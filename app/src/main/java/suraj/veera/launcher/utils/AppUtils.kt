package suraj.veera.launcher.utils
    ...
    fun getRunningTasks(
        ...
        for (taskInfo in tasksInfo) {
            try {
                ...
                if (!(taskInfo.topActivity!!.className == "suraj.veera.launcher.activities.MainActivity" || taskInfo.topActivity!!.className == "suraj.veera.launcher.activities.DebugActivity") && taskInfo.topActivity!!.packageName == getCurrentLauncher(
                        packageManager
                    )
                ) continue
