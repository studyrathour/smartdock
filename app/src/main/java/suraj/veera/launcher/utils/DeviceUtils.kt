...
import suraj.veera.launcher.services.DockService
...
object DeviceUtils {
    ...
    private const val SERVICE_NAME = "suraj.veera.launcher/suraj.veera.launcher.services.DockService"
    ...
    fun grantPermission(permission: String): Boolean {
        val result = runAsRoot("pm grant suraj.veera.launcher $permission")
